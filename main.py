import os
os.chdir(r"Z:\Drew's Stuff\GitHub\ETL_Python_GraphDataLoad")
...
infile = pd.read_csv(r"C:/Users/ARiffle/Desktop/minotaur_converted_csv.csv", na_filter=False, chunksize=1000, sep=',', dtype=object)
...
#----Start of Transaction Section---------------------------------------------------------------------------------
        ...
        Transaction_ID = 'tx-' + str(hashlib.sha128(line['transactionLookUp'].encode('utf-8')).hexdigest())
...
#    #----Start of Sender Section-----------------------------------------------------------------------------------------
        ...
        #Name
        Name_ID = 'name-' + str(hashlib.sha128(line['sNameClean_fullName'].title().encode('utf-8')).hexdigest())
...
#        Address_ID = 'address-' + str(hashlib.sha128(addr_dict['Full_Address'].encode('utf-8')).hexdigest())
...
#             addr_dict['State'], addr_dict['Postal'], addr_dict['Country'], addr_dict['Latitude'], addr_dict['Longitude'], Entity_Type, Entity_ID, Address_ID)
        ...
        Address_ID = 'address-' + str(hashlib.sha128(line['sAddrClean_fullAddress'].encode('utf-8')).hexdigest())
        ...
        #DOB
        DOB_ID = 'dob-' + str(hashlib.sha128(line['sDOBClean'].encode('utf-8')).hexdigest())
        ...
        Phone_Cleaned_ID = 'phone-' + str(hashlib.sha128(phone_dict['E164'].encode('utf-8')).hexdigest())
        ...
        if len(line['sCustomerID_online']) > 0: #Online flag = True
            Customer_ID = 'customerID-' + str(hashlib.sha128(line['sCustomerID_online'].encode('utf-8')).hexdigest())
            ...
            Credit_Card_ID = 'creditcard-' + str(hashlib.sha128(line['sCreditCardNumber'].encode('utf-8')).hexdigest())
        ...
        if len(line['sCustomerID_online']) == 0: #Online flag = False
            Customer_ID = 'person-' + str(hashlib.sha128(line['sCustomerID'].encode('utf-8')).hexdigest())
        ...
        #Occupation
        Occupation_ID = 'occupation-' + str(hashlib.sha128(line['sOccupation'].title().encode('utf-8')).hexdigest())
        query = query + ig.graphLoad_Occupation(Added_Date_Time, Added_User, line['sOccupation'], Entity_Type, Entity_ID, Occupation_ID)

        #Loyalty ID
        Loyalty_ID = 'misc-' + str(hashlib.sha128(line['sLoyaltyLookUp'].encode('utf-8')).hexdigest())
        ...
        #Bank Account
        Bank_Account_ID = 'bankaccount-' + str(hashlib.sha128(line['sBankAcnt_LookUp'].encode('utf-8')).hexdigest())
        ...
        #----Identification_1----
        Identification_ID = 'id-' + str(hashlib.sha128(line['sID1LookUp'].encode('utf-8')).hexdigest())
        ...
        #----Identification_2----
        Identification_ID = 'id-' + str(hashlib.sha128(line['sID2LookUp'].encode('utf-8')).hexdigest())
        ...
        #----IP_Address_1----
        IP_Address_ID = 'ip-' + str(hashlib.sha128(line['sIPAddr1'].encode('utf-8')).hexdigest())
        ...
        #----IP_Address_2----
        IP_Address_ID = 'ip-' + str(hashlib.sha128(line['sIPAddr2'].encode('utf-8')).hexdigest())
        query = query + ig.graphLoad_IP_Address(Added_Date_Time, Added_User, line['sIPAddr2'], line['sIPAddr2_exclude'],
                        Entity_Type, Entity_ID, IP_Address_ID)

        #----Device_1----
        Device_ID = 'device-' + str(hashlib.sha128(line['sDeviceID1'].encode('utf-8')).hexdigest())
        ...
        #----Device_2----
        Device_ID = 'device-' + str(hashlib.sha128(line['sDeviceID2'].encode('utf-8')).hexdigest())
        ...
        #----Email_1----
        Email_ID = 'email-' + str(hashlib.sha128(line['sEMail1'].encode('utf-8')).hexdigest())
        ...
        #----Email_2----
        Email_ID = 'email-' + str(hashlib.sha128(line['sEMail2'].encode('utf-8')).hexdigest())
    ...
    #----Start of Payee Section-------------------------------------------------------------------------------------
        ...
        #Name
        Name_ID = 'name-' + str(hashlib.sha128(line['pNameClean_fullName'].title().encode('utf-8')).hexdigest())
...
#        Address_ID = 'str_addr' + str(hashlib.sha128(addr_dict['Full_Address'].encode('utf-8')).hexdigest())
#        addr_dict['Country'] = 'Merica'
#        query = query + ig.graphLoad_Address(Added_Date_Time, Added_User, addr_dict['Full_Address'], addr_dict['Street'], addr_dict['City'],
#             addr_dict['State'], addr_dict['Postal'], addr_dict['Country'], addr_dict['Latitude'], addr_dict['Longitude'], Entity_Type, Entity_ID, Address_ID)
        ...
        #DOB
        DOB_ID = 'dob-' + str(hashlib.sha128(line['pDOBClean'].encode('utf-8')).hexdigest())
        ...
        Phone_ID = 'phone-' + str(hashlib.sha128(phone_dict['E164'].encode('utf-8')).hexdigest())
        ...
        if len(line['pCustomerID_online']) > 0: #Online flag = True
            Customer_ID = 'person-' + str(hashlib.sha128(line['pCustomerID_online'].encode('utf-8')).hexdigest())
            ...
            Credit_Card_ID = 'creditcard-' + str(hashlib.sha128(line['pCreditCardNumber'].encode('utf-8')).hexdigest())
        ...
        if len(line['pCustomerID_online']) == 0: #Online flag = False
            Customer_ID = 'person-' + str(hashlib.sha128(line['pCustomerID'].encode('utf-8')).hexdigest())
        ...
        #Occupation
        Occupation_ID = 'occupation-' + str(hashlib.sha128(line['pOccupation'].title().encode('utf-8')).hexdigest())
        query = query + ig.graphLoad_Occupation(Added_Date_Time, Added_User, line['pOccupation'], Entity_Type, Entity_ID, Occupation_ID)

        #Loyalty ID
        Loyalty_ID = 'loyalty-' + str(hashlib.sha128(line['pLoyaltyLookUp'].encode('utf-8')).hexdigest())
        ...
        #Bank Account
        Bank_Account_ID = 'bank_account-' + str(hashlib.sha128(line['pBankAcnt_lookUp'].encode('utf-8')).hexdigest())
        query = query + ig.graphLoad_Bank_Account(Added_Date_Time, Added_User, line['pBank_AccountNumber'], line['pBankAcnt_lookUp'],
         ...
         #----Identification_1----
        Identification_ID = 'identification-' + str(hashlib.sha128(line['pID1LookUp'].encode('utf-8')).hexdigest())
        query = query + ig.graphLoad_Identification(Added_Date_Time, Added_User, line['pID1Number'], line['pID1Type'],
         ...
         #----Identification_2----
        Identification_ID = 'identification-' + str(hashlib.sha128(line['pID2LookUp'].encode('utf-8')).hexdigest())
        query = query + ig.graphLoad_Identification(Added_Date_Time, Added_User, line['pID2Number'], line['pID2Type'],
         ...
         #----IP_Address_1----
        IP_Address_ID = 'ip-' + str(hashlib.sha128(line['pIPAddr1'].encode('utf-8')).hexdigest())
        query = query + ig.graphLoad_IP_Address(Added_Date_Time, Added_User, line['pIPAddr1'], line['pIPAddr1_exclude'], Entity_Type,
         ...
         #----IP_Address_2----
        IP_Address_ID = 'ip-' + str(hashlib.sha128(line['pIPAddr2'].encode('utf-8')).hexdigest())
        query = query + ig.graphLoad_IP_Address(Added_Date_Time, Added_User, line['pIPAddr2'], line['pIPAddr2_exclude'], Entity_Type,
                         Entity_ID, IP_Address_ID)

         #----Device_1----
        Device_ID = 'device-' + str(hashlib.sha128(line['pDeviceID1'].encode('utf-8')).hexdigest())
        query = query + ig.graphLoad_Device(Added_Date_Time, Added_User, line['pDeviceDesc1'], line['pDeviceOS1'],
         ...
         #----Device_2----
        Device_ID = 'device-' + str(hashlib.sha128(line['pDeviceID2'].encode('utf-8')).hexdigest())
        query = query + ig.graphLoad_Device(Added_Date_Time, Added_User, line['pDeviceDesc2'], line['pDeviceOS2'],
         ...
         #----Email_1----
        Email_ID = 'email-' + str(hashlib.sha128(line['pEMail1'].encode('utf-8')).hexdigest())
        query = query + ig.graphLoad_Email(Added_Date_Time, Added_User, line['pEMail1'], line['pEmail1_exclude'], Entity_Type, Entity_ID, Email_ID)
         ...
         #----Email_2----
        Email_ID = 'email-' + str(hashlib.sha128(line['pEMail2'].encode('utf-8')).hexdigest())
    ...
    # #----Start of On Behalf Sender Section--------------------------------------------------------------------------
        ...
        #Name
        Name_ID = 'name-' + str(hashlib.sha128(line['sOnBehalf_NameClean_fullName'].encode('utf-8')).hexdigest())
...
#             addr_dict['State'], addr_dict['Postal'], addr_dict['Country'], addr_dict['Latitude'], addr_dict['Longitude'], Entity_Type, Entity_ID, Address_ID)
        ...
        #DOB
        DOB_ID = 'dob-' + str(hashlib.sha128(line['sOnBehalf_DOBClean'].encode('utf-8')).hexdigest())
        ...
        Customer_ID = 'person-' + str(hashlib.sha128(line['sOnBehalf_CustomerID'].encode('utf-8')).hexdigest())
        ...
        #Occupation
        Occupation_ID = 'occupation-' + str(hashlib.sha128(line['sOnBehalf_Occupation'].encode('utf-8')).hexdigest())
        query = query + ig.graphLoad_Occupation(Added_Date_Time, Added_User, line['sOnBehalf_Occupation'], Entity_Type, Entity_ID, Occupation_ID)
         ...
         #----Identification_1----
        Identification_ID = 'id_num-' + str(hashlib.sha128(line['sOnBehalf_ID1LookUp'].encode('utf-8')).hexdigest())
        query = query + ig.graphLoad_Identification(Added_Date_Time, Added_User, line['sOnBehalf_ID1Number'], line['sOnBehalf_ID1Type'],
         ...
         #----Identification_2----
        Identification_ID = 'id_num-' + str(hashlib.sha128(line['sOnBehalf_ID2LookUp'].encode('utf-8')).hexdigest())
    ...
    # #----Start of Sender Agent Section-----------------------------------------------------------------------------------------------
        ...
        #Agent
        Agent_ID = 'agent-' + str(hashlib.sha128(line['sAgentName'].title().encode('utf-8')).hexdigest())
...
#             addr_dict['State'], addr_dict['Postal'], addr_dict['Country'], addr_dict['Latitude'], addr_dict['Longitude'], Entity_Type, Entity_ID, Address_ID)
        ...
        #Clerk
        Clerk_ID = 'clerk-' + str(hashlib.sha128(line['sAgentClerk'].encode('utf-8')).hexdigest())
    ...
    # #----Start of Payee Agent Section-----------------------------------------------------------------------------------------------
        ...
        #Agent
        Agent_ID = 'agent-' + str(hashlib.sha128(line['pAgentName'].encode('utf-8')).hexdigest())
...
#             addr_dict['State'], addr_dict['Postal'], addr_dict['Country'], addr_dict['Latitude'], addr_dict['Longitude'], Entity_Type, Entity_ID, Address_ID)
        ...
        #Clerk
        Clerk_ID = 'clerk-' + str(hashlib.sha128(line['pAgentClerk'].encode('utf-8')).hexdigest())
